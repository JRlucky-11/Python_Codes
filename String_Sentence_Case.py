...
if(ch == 1):
    ...
    print("\t|>> Your title case sentence is:", a.title())
    print("\t|>> Your capitalized sentence is:", a.capitalize())
    print("\t|>> Your uppercase sentence is:", a.upper())
    print("\t|>> Your lowercase sentence is:", a.lower())
elif(ch == 2):
    print("\t|>> Your sentence is: ", a)
    ch1 = input("\t|>> Enter the character you want to replace: ")
    ch2 = input("\t|>> Enter the character you want to replace with: ")
    print("\t|>> Your sentence with '", ch1, "' replaced by '", ch2, "' is:", a.replace(ch1, ch2))
